...
ตัว standalone skill อยู่ที่ `skills/pasadu/` ใน repository นี้ path อย่าง `SKILL.md`, `reference/`, `scripts/` และ `data/` ที่กล่าวในเอกสารนี้ให้อ่านเทียบจาก directory ดังกล่าว
...
`build_index.py` แตกเอกสารกฎหมายและระเบียบเป็น chunks ตามหน่วยตัวบท เช่น:

```text
พระราชบัญญัติการจัดซื้อจัดจ้างและการบริหารพัสดุภาครัฐ พ.ศ. 2560 มาตรา 56
...
4. งานค้นคืนและการวิเคราะห์ทั้งหมดอยู่ในบทสนทนาปัจจุบัน; standalone skill ไม่พึ่ง custom subagent
